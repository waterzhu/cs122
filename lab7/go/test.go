...
func main(){
		...
		MenuConfig("sum", "Get sum of two integer.(use as 'sum x x')", sum)
		MenuConfig("compare", "Compare two integer.(use as 'compare x x')", compare)
		MenuConfig("echo", "Output what you input.(use as 'echo xxxxx')", echo)
		MenuConfig("ls", "List files in this dir.", ls)
		MenuConfig("mkdir", "make a new dir.", mkdir)
		ExecuteMenu()
